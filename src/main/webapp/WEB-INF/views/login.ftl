			...
			<div class="loginForm">
				<form method="post" action="${request.contextPath}/login" id="formID" >
					...
					<p>
						...
						<span><img src="${request.contextPath}/Captcha.jpg" alt="点击刷新验证码" width="75" height="24" id="captcha" style="cursor:pointer"/></span>
					</p>
					<p/>
					<p/>
					<p/>
					...
					<p/>
					<p/>					
					<div class="login_bar" style="disply:block;float:center;">
						<input class="sub" type="submit" value=""/>
					</div>
				</form>
			</div>
			<div class="login_banner"><img src="${request.contextPath}/styles/management/themes/default/images/login_banner.png" /></div>
